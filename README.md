...
Я начал заниматься веб разработкой где-то год назад. Сначала освоил HTML и CSS, потом постепенно перешел на JS, однако тогда я не стал долго на нем задерживаться и кинулся учить PHP и MySQL. Наверстал свой первый сайт-портфолио, с адаптивным дизайном и с формой с проверкой ввода на JS и отправкой писем на PHP.
